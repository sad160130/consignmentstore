...
def load_data():
    ...
    try:
        ...
        json_path = os.path.join(os.path.dirname(__file__), 'data', 'SEO_Optimized_Consignment_Stores_Sample_Dataset.json')
        if os.path.exists(json_path):
            ...
            excel_path = os.path.join(os.path.dirname(__file__), 'data', 'SEO_Optimized_Consignment_Stores_Sample_Dataset.xlsx')
